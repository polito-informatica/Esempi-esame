...
print(open('prenotati_appello1.txt', 'r').read())
print()
print(open('prenotati_appello2.txt', 'r').read())
print()
print(open('prenotati_appello3.txt', 'r').read())
print()
print(open('consegne_appello1.txt', 'r').read())
print()
print(open('consegne_appello2.txt', 'r').read())
print()
print(open('consegne_appello3.txt', 'r').read())
print()
